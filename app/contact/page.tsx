                        ...
                        <AnimatePresence mode="wait">
                            {!submitted ? (
                                <motion.div
                                    ...
                                    className="glass-card p-12 rounded-[3.5rem] border-gray-200 relative overflow-hidden"
                                >
                                        ...
                                        <div className="space-y-6">
                                            <div className="space-y-2">
                                                ...
                                                <input
                                                    ...
                                                    className="w-full px-8 py-5 bg-gray-50 border border-gray-200 rounded-2xl text-white placeholder-white/10 font-bold focus:outline-none focus:border-primary/50 transition-all"
                                                    value={formData.name}
                                            ...
                                            <div className="space-y-2">
                                                ...
                                                <textarea
                                                    ...
                                                    className="w-full px-8 py-5 bg-gray-50 border border-gray-200 rounded-2xl text-white placeholder-white/10 font-bold focus:outline-none focus:border-primary/50 transition-all resize-none"
                                ...
                                <motion.div
                                    ...
                                    className="glass-card p-20 rounded-3xl border-primary/20 text-center relative overflow-hidden flex flex-col items-center justify-center min-h-[500px]"
                                >
                                    ...
                                    <button
                                        ...
                                        className="text-[10px] font-black tracking-[0.4em] uppercase text-gray-300 hover:text-gray-900 transition-colors flex items-center gap-2"
                                    >
