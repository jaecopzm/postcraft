          ...
          {!verificationSent ? (
            <>
              ...
              <motion.button
                ...
                whileHover={{ scale: 1.02 }}
                whileTap={{ scale: 0.98 }}
                className="w-full bg-white text-black font-black py-4 sm:py-5 px-6 sm:px-8 rounded-2xl transition-all shadow-xl flex items-center justify-center gap-3 hover:shadow-white/10 group mb-10"
              >
                {isLoading ? (
