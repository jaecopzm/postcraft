...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-[#050505] text-white selection:bg-primary/30 relative overflow-hidden font-sans">
      ...
      <div className="absolute bottom-0 left-[-10%] w-[800px] h-[800px] bg-primary/5 blur-[150px] pointer-events-none rounded-full" />
      ...
      <nav className="fixed top-0 left-0 right-0 z-[100] border-b border-white/5 bg-[#050505]/70 backdrop-blur-xl">
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          <Link href="/" className="flex items-center gap-3 group">
            ...
            <span className="text-xl font-black tracking-widest uppercase">PostCraft</span>
          </Link>
          <div className="flex items-center gap-4">
            {user ? (
              <Link href="/dashboard" className="px-6 py-2.5 bg-white text-black text-xs font-black tracking-widest uppercase rounded-full hover:scale-105 transition-all shadow-xl shadow-white/5">
                Terminal
              </Link>
            ) : (
              <>
                <Link href="/auth/signin" className="px-6 py-2.5 text-xs font-black tracking-widest uppercase text-white/50 hover:text-white transition-colors">
                  Login
                </Link>
                <Link href="/auth/signup" className="px-8 py-2.5 premium-gradient text-white text-xs font-black tracking-widest uppercase rounded-full hover:scale-105 transition-all shadow-xl shadow-primary/20">
                  Join Beta
                </Link>
              </>
            )}
      ...
      {/* Hero Section */}
      <section className="pt-44 pb-32 px-6 max-w-7xl mx-auto text-center relative z-10">
        <motion.div
        ...
        >
          <motion.div variants={itemVariants} className="inline-flex items-center gap-3 px-4 py-2 bg-primary/10 border border-primary/20 rounded-full mb-10">
            <div className="w-1.5 h-1.5 bg-primary rounded-full animate-pulse" />
            <span className="text-[10px] font-black tracking-[0.3em] uppercase text-primary">Neural Content Engine v4.0</span>
          </motion.div>
          ...
          <motion.p variants={itemVariants} className="text-xl md:text-2xl text-white/40 font-medium mb-12 max-w-2xl mx-auto leading-relaxed">
            Generate cinematic content for every digital frontier in seconds.
            One interface. Infinite momentum.
          </motion.p>

          <motion.div variants={itemVariants} className="flex flex-col sm:flex-row items-center justify-center gap-6">
            <Link href="/auth/signup" className="w-full sm:w-auto px-12 py-6 premium-gradient rounded-2xl text-white font-black tracking-[0.2em] uppercase text-sm shadow-2xl shadow-primary/30 group relative overflow-hidden transition-all hover:scale-105">
            ...
            <Link href="/auth/signin" className="w-full sm:w-auto px-12 py-6 glass-card border-white/10 rounded-2xl text-white/50 font-black tracking-[0.2em] uppercase text-sm hover:text-white hover:border-white/20 transition-all">
              Watch Intel
            </Link>
          </motion.div>
        </motion.div>
      ...
      <motion.div
        ...
        viewport={{ once: true }}
        className="border-y border-white/5 bg-white/[0.02] py-20 px-6"
      >
        <div className="max-w-7xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-12 text-center">
          {[
            ...
            <div key={i} className="space-y-2">
              <div className="flex items-center justify-center gap-2 text-primary/40 mb-3">
                <stat.icon className="h-4 w-4" />
              </div>
              <div className="text-4xl font-black text-white tracking-tighter">{stat.value}</div>
              <div className="text-[10px] font-black tracking-[0.3em] text-white/20 uppercase">{stat.label}</div>
            </div>
          ))}
        </div>
      </motion.div>
      ...
      <section className="py-32 px-6 max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row items-end justify-between gap-8 mb-20">
          <div className="max-w-2xl">
            ...
            <h3 className="text-5xl font-black tracking-tight leading-tight">BUILT FOR THE<br />MODERN ARCHITECT.</h3>
          </div>
          <p className="max-w-xs text-white/30 font-medium leading-relaxed">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {[
            ...
            >
              ...
              <div className="w-16 h-16 premium-gradient rounded-2xl flex items-center justify-center shadow-lg shadow-primary/20 mb-10">
                <feature.icon className="h-8 w-8 text-white" />
              </div>
              <h4 className="text-2xl font-black text-white tracking-tight mb-4">{feature.title}</h4>
      ...
      <section className="py-32 px-6">
        <div className="max-w-5xl mx-auto relative">
          <motion.div
            ...
            viewport={{ once: true }}
            className="glass-card rounded-[4rem] p-20 text-center border-white/5 relative overflow-hidden"
          >
            <div className="absolute inset-0 bg-primary/5 blur-[120px] pointer-events-none" />
            <h2 className="text-5xl md:text-7xl font-black tracking-tighter mb-8 max-w-3xl mx-auto leading-[0.9]">
              JOIN THE <span className="text-gradient">NEW STANDARD</span> OF CREATION.
            </h2>
            <p className="text-white/30 text-lg font-medium mb-12 max-w-xl mx-auto">
              The noise is deafening. Let's make sure your voice cutting through it is effortless.
            </p>
            <Link href="/auth/signup" className="inline-flex px-12 py-6 premium-gradient rounded-2xl text-white font-black tracking-[0.2em] uppercase text-sm shadow-2xl transition-all hover:scale-105 active:scale-95">
